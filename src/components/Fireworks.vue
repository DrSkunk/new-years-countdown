<!--  Source: https://github.com/dampion/Vue-fireworks/blob/master/src/components/fireworks.vue -->
<template>
  <div class="absolute left-0 top-0 w-screen h-screen overflow-hidden">
